...
# %% [markdown]
#
# Il est toujours bon de mettre en perspective l'erreur moyenne obtenue avec la
# variable cible. En effet, notre modèle commet une erreur de 450 grammes sur
# notre données alors que l'écart-type de la variable cible est de 800 grammes.
# Notre modèle n'est donc pas un très bon modèle.
#
# Quand on compare les distributions, nous regardons si ces distributions se
# chevauchent. Si les distributions se chevauchent et que leur moyennes et leur
# écart-types sont proches, alors le modèle est capable de généraliser. Une
# différence entre les distributions nous permet de conclure sur le sous- ou
# sur-apprentissage. En revanche, quand les écart-types sont trop larges, ceci
# est souvent lié à un manque de données et il sera difficile de tirer des
# conclusions.
